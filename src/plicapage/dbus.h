...
class PlicaPageDbus: public QObject
{
    Q_OBJECT
    Q_CLASSINFO("D-Bus Interface", "org.plicapage")
public:
    PlicaPageDbus(const QString &serviceName, const QString &dbusPath);
    ~PlicaPageDbus();

    static bool runPlicaPage(const QString &file);
