 ...
 * File format
 *
 * First line - \x1B%-12345X@PJL PLICAPAGE_PROJECT
 *
 * Project meta info:
 *  @PJL PLICAPAGE META_AUTHOR="str"      - author
 *  @PJL PLICAPAGE META_TITLE="str"       - title
 *  @PJL PLICAPAGE META_SUBJECT="str"     - subject
 *  @PJL PLICAPAGE META_KEYWORDS="str"    - keywords
 *
 * Job:
 *  @PJL PLICAPAGE JOB_TITLE="str"        - title of job
 *  @PJL PLICAPAGE JOB_PAGES="pagesSpec"  - define pages state
 *                                          hidden, inserted
 *
