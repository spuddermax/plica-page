...
#ifndef PLICAPAGETYPES_H
#define PLICAPAGETYPES_H
#include <QMetaType>
#include <QDataStream>
#include <QVariant>
#include <QRectF>
...
class PlicaPageError: public std::runtime_error
{
public:
    explicit PlicaPageError(const char *msg): std::runtime_error(msg){}
    explicit PlicaPageError(const std::string &msg): std::runtime_error(msg){}
    explicit PlicaPageError(const QString &msg): std::runtime_error(msg.toStdString()){}
};
