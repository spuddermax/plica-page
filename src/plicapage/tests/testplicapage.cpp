 ...
 *
 * ***********************************************/
TestPlicaPage::TestPlicaPage(QObject *parent):
    QObject(parent),
 ...
 *
 ************************************************/
void TestPlicaPage::initTestCase()
{
 ...
 *
 * ***********************************************/
void TestPlicaPage::test_RotationType()
{
 ...
 ************************************************/
void TestPlicaPage::test_ProjectRotation()
{
    QFETCH(int,      exp);
 ...
 ************************************************/
void TestPlicaPage::test_ProjectRotation_data()
{
 ...
 *
 * ***********************************************/
LayoutNUp *TestPlicaPage::createLayout(const QString &name)
{
 ...
 *
 * ***********************************************/
Rotation TestPlicaPage::StrToRotation(const QString &str)
{
 ...
 ************************************************/
QList<ProjectPage *> TestPlicaPage::createPages(const QString &definition)
{
 ...
 *
 * ***********************************************/
Sheet *TestPlicaPage::createSheet(const QString &definition)
{
 ...
 *
 * ***********************************************/
Sheet *TestPlicaPage::createSheet(int pagePerSheet, int pageRotation, QRectF mediaBox, QRectF cropBox)
{
 ...
 *
 * ***********************************************/
void TestPlicaPage::test_PageRotation()
{
    QFETCH(int,      exp);
    Rotation expected = NoRotate + exp;
 ...
 *
 * ***********************************************/
void TestPlicaPage::test_PageRotation_data()
{
    QTest::addColumn<int>("exp");
 ...
 ************************************************/
void TestPlicaPage::test_PagePosition()
{
 ...
 ************************************************/
void TestPlicaPage::test_PagePosition_data()
{
 ...
 *
 * ***********************************************/
void TestPlicaPage::test_BooFilePageSpec()
{
 ...
 *
 * ***********************************************/
void TestPlicaPage::test_BooFilePageSpec_data()
{
 ...
 *
 * ***********************************************/
void TestPlicaPage::test_BooklesSplit()
{
 ...
 *
 * ***********************************************/
void TestPlicaPage::test_BooklesSplit_data()
{
    QTest::addColumn<QString>("expected");
 ...
 *
 ************************************************/
void TestPlicaPage::testEscapeString()
{
    QFETCH(QString, in);
 ...
 *
 ************************************************/
void TestPlicaPage::testEscapeString_data()
{
 ...
 *
 ************************************************/
QString TestPlicaPage::dir(const QString &subTest)
{
...
QTEST_GUILESS_MAIN(TestPlicaPage)
