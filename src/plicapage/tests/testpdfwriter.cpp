 ...
 *
 ************************************************/
void TestPlicaPage::testPdfWriter_SprintUint()
{
    QFETCH(int,     value);
 ...
 *
 ************************************************/
void TestPlicaPage::testPdfWriter_SprintUint_data()
{
 ...
 *
 ************************************************/
void TestPlicaPage::testPdfWriter_SprintInt()
{
    QFETCH(int,     value);
    QFETCH(QString, expected);
    QFETCH(int,     expectedLen);
 ...
 *
 ************************************************/
void TestPlicaPage::testPdfWriter_SprintInt_data()
{
    QTest::addColumn<int>("value");
    QTest::addColumn<QString>("expected");
    QTest::addColumn<int>("expectedLen");
 ...
 *
 ************************************************/
void TestPlicaPage::testPdfWriter_SprintDouble()
{
    QFETCH(double,  value);
    QFETCH(QString, expected);
    QFETCH(int,     expectedLen);
 ...
 *
 ************************************************/
void TestPlicaPage::testPdfWriter_SprintDouble_data()
{
 ...
 *
 ************************************************/
void TestPlicaPage::testPdfReader_WriteStringHex()
{
    QFETCH(int,     expectedLen);
 ...
 *
 ************************************************/
void TestPlicaPage::testPdfReader_WriteStringHex_data()
{
    QTest::addColumn<int>(    "expectedLen");
 ...
 *
 ************************************************/
void TestPlicaPage::testPdfReader_WriteStringLiteral()
{
    QFETCH(int,     expectedLen);
    QFETCH(QString, value);
    QFETCH(QString, expected);
 ...
 *
 ************************************************/
void TestPlicaPage::testPdfReader_WriteStringLiteral_data()
{
    QTest::addColumn<int>(    "expectedLen");
    QTest::addColumn<QString>("value");
    QTest::addColumn<QString>("expected");
