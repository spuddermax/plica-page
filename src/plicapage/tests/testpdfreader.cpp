 ...
 *
 ************************************************/
void TestPlicaPage::testPdfReader_ReadName()
{
    QFETCH(QString, data);
    QFETCH(int,     pos);
 ...
 *
 ************************************************/
void TestPlicaPage::testPdfReader_ReadName_data()
{
 ...
 *
 ************************************************/
void TestPlicaPage::testPdfReader_ReadLink()
{
    QFETCH(QString, data);
    QFETCH(int,     pos);
 ...
 *
 ************************************************/
void TestPlicaPage::testPdfReader_ReadLink_data()
{
    QTest::addColumn<QString>("data");
    QTest::addColumn<int>("pos");
 ...
 *
 ************************************************/
void TestPlicaPage::testPdfReader_ReadNum()
{
 ...
 *
 ************************************************/
void TestPlicaPage::testPdfReader_ReadNum_data()
{
 ...
 *
 ************************************************/
void TestPlicaPage::testPdfReader_ReadStringHex()
{
    QFETCH(int,     pos);
    QFETCH(int,     expectedPos);
    QFETCH(QString, data);
 ...
 *
 ************************************************/
void TestPlicaPage::testPdfReader_ReadStringHex_data()
{
    QTest::addColumn<int>("pos");
    QTest::addColumn<int>("expectedPos");
    QTest::addColumn<QString>("data");
 ...
 *
 ************************************************/
void TestPlicaPage::testPdfReader_ReadStringLiteral()
{
    QFETCH(int,     pos);
    QFETCH(int,     expectedPos);
    QFETCH(QString, data);
 ...
 *
 ************************************************/
void TestPlicaPage::testPdfReader_ReadStringLiteral_data()
{
    QTest::addColumn<int>("pos");
    QTest::addColumn<int>("expectedPos");
    QTest::addColumn<QString>("data");
